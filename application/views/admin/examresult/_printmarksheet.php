...
// print_r($template);
                ...
                <style type="text/css">
                    ...
                    .tableone{}
                    .tableone td{border:0px solid #000; padding: 0px 0}
                    .denifittable th{border-top: 0px solid #999;}
                    .denifittable th,
                    .denifittable td {border-bottom: 0px solid #999;
                                      border-collapse: collapse;border-left: 0px solid #999;}
           ...
           .tcmybg {
            ...
            .tablemain{position: relative;z-index: 2}
                ...
                <div style="width: 100%; margin: 0 auto; border:0px solid #000; padding: 10px 5px 5px;position: relative; z-index: 2;">
                     <?php
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        if ($template->left_logo) {
                                            ?>
                                                <img src="<?php echo base_url('uploads/marksheet/' . $template->left_logo); ?>" width="200" height="100">
                                            <?php
                                        }
                                        ?>
...
<td width="100" valign="top" align="right" style="padding-right: 20px;">
                                        ...
                                        if ($template->right_logo) {
                                            ?>
                                                <img src="<?php echo base_url('uploads/marksheet/' . $template->right_logo); ?>" width="200" height="100">
                                            <?php
                                        }
                                        ?>
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="98%" class="denifittable">
                                                    ...
                                                    <tr>
                                                        ...
                                                        if ($template->is_roll_no) {
                                                            ?>
                                                            <th valign="top" style="text-align: center; text-transform: uppercase; border-right:0px solid #999"><?php echo $this->lang->line('roll_no') ?></th>
                                                            <?php
                                                        }
                                                        ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        if ($template->is_roll_no) {
                                                            ?>
                                                            <td valign="" style="text-transform: uppercase;text-align: center;border-right:0px solid #999"><?php echo $student_value['exam_roll_no']; ?></td>
                                                            <?php
                                                        }
                                                        ?>
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%" class="denifittable" style="text-align: center;">
                                        <thead>
                                            <tr>
                                                ...
                                                ?>
                                                <th valign="top" style="text-align: left;border-right:0px solid #999"><?php echo $this->lang->line('remark') ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            foreach ($student_value['exam_result'] as $exam_result_key => $exam_result_value) {
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                    <td valign="top" style="text-align: left;border-right:0px solid #999">
                                                        <?php
                                            ...
                                            if ($exam->exam_group_type != "gpa") {
                                                ...
                                                <tr>
                                                    ...
                                                    if ($exam->exam_group_type == "school_grade_system" || $exam->exam_group_type == "coll_grade_system") {
                                                        ?>
                                                        <td valign="top" style="text-align: left;border-right:0px solid #999"></td>
                                                        <?php
                                                    }
                                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            if ($template->left_sign != "") {
                                                ...
                                                <td valign="bottom" align="center" style="text-transform: uppercase;">
                                                    ...
                                                    <img src="<?php echo base_url('uploads/marksheet/' . $template->left_sign); ?>"  width="200" height="100">
    ...
    if ($marksheet['exam_connection'] == 1) {
        ...
        foreach ($marksheet['students'] as $student_key => $student_value) {
            ...
            <html lang="en">
                ...
                <body>
                    <div style="width: 1000px; margin: 0 auto; border:0px solid #000; padding: 10px 5px 5px">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr><td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                                ...
                                                <td valign="top">
                                                    <table cellpadding="0" cellspacing="0" width="98%" class="denifittable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            if ($template->is_roll_no) {
                                                                ?>
                                                                <td valign="" style="text-transform: uppercase;text-align: center;border-right:0px solid #999">   <?php echo $student_value['exam_result']['exam_roll_no_' . $exam->id]; ?>
                                                                </td>
                                                                <?php
                                                            }
                                                            ?>
                                                        ...
                                                        <tr>
                                                            <td valign="top" colspan="5" style="text-align: center; text-transform: uppercase; border:0">
                                                                ...
                                                                <?php echo $this->lang->line('Statement_of_Results') ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <?php
...
// print_r($marksheet['exams']);
                                                        ...
                                                        ?>
                                                        <th valign="top" style="text-align: left;border-right:0px solid #999"><?php echo $this->lang->line('consolidate') ?></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                            ...
                                            if (!$consolidate_exam_status) {
                                                ...
                                                echo $this->lang->line('') . " " . $this->lang->line('');
                                            } else {
                                ...
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%" class="">
                                        <tr>
                                            ...
                                            if ($template->left_sign != "") {
                                                ?>
                                                <img src="<?php echo base_url('uploads/marksheet/' . $template->left_sign); ?>"  width="200" height="100"><?php } ?>
                                                <p><?php echo $this->lang->line('seal_and_signature_of_the_principal'); ?></p></td>
                                            <td valign="bottom" align="center" style="text-transform: uppercase;">
                                                <?php
                                            if ($template->middle_sign != "") {
                                                ?>
                                                <img src="<?php echo base_url('uploads/marksheet/' . $template->middle_sign); ?>" width="200" height="100">
                                            <?php } ?>
                                            ...
                                            if ($template->right_sign != "") {
                                                ?>
                                                <img src="<?php echo base_url('uploads/marksheet/' . $template->right_sign); ?>" width="200" height="100">
                                            <?php } ?>
                                                <p><?php echo $this->lang->line('secretary'); ?></p></td>
