            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    <?php }if ($this->rbac->hasPrivilege('student_gender_ratio_report', 'can_view')) {
						...
						<?php } ?>
						<li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/disabled_report'); ?>"><a href="<?php echo base_url(); ?>student/disabled_report"><i class="fa fa-file-text-o"></i>Disabled Student</a></li>
