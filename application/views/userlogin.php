                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                                <div class="loginbg loginradius login390">
                                    ...
                                    <div class="form-bottom text-center">
                                        <h3 class="font-white text-center"><strong>Student Login</strong></h3>
                                        <?php
...
?>
                                        ...
                                        <p class="text-center"><a href="<?php echo site_url('site/ufpassword') ?>" class="forgot"> <i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?></a> </p>
                                    </div>
                                </div>
                            </div>
                            <?php
