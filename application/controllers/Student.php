...
class Student extends Admin_Controller
{
    ...
    public function create()
    {
        ...
        $this->form_validation->set_rules('id-passport', 'ID passport', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
			...
			$id_passport      = $this->input->post('id-passport');
			...
			if (isset($father_email)) {

                $data['father_email'] = $this->input->post('father_email');
            }
			
            if (isset($mother_email)) {

                $data['mother_email'] = $this->input->post('mother_email');
            }
			
			if (isset($id_passport)) {

                $data['id-passport'] = $this->input->post('id-passport');
            }
